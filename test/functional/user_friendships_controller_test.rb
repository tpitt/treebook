...
class UserFriendshipsControllerTest < ActionController::TestCase
  ...
  context "#index" do
    ...
    context "when logged in" do
      setup do
        @friendship1 = create(:pending_user_friendship, user: users(:tyson), friend: create(:user, first_name: 'Pending', last_name: 'Friend'))
        @friendship2 = create(:accepted_user_friendship, user: users(:tyson), friend: create(:user, first_name: 'Active', last_name: 'Friend'))
        @friendship3 = create(:requested_user_friendship, user: users(:tyson), friend: create(:user, first_name: 'Requested', last_name: 'Friend'))
  ...
  context "#new" do
      ...
      should "assign a new user friendship to the currently logged in user" do
        get :new, friend_id: users(:jim)
        assert_equal users(:tyson), assigns(:user_friendship).user
      end
  ...
  context "#accept" do
    ...
    context "when logged in" do
      setup do
        @friend = create(:user)
        @user_friendship = create(:pending_user_friendship, user: users(:tyson), friend: @friend)
        create(:pending_user_friendship, friend: users(:tyson), user: @friend)
        sign_in users(:tyson)
  ...
  context "#edit" do
    ...
    context "when logged in" do
      setup  do
        @user_friendship = create(:pending_user_friendship, user: users(:tyson))
        sign_in users(:tyson)
  ...
  context "#destroy" do
    ...
    context "when logged in" do
      setup do
        @friend = create(:user)
        @user_friendship = create(:accepted_user_friendship, friend: @friend, user: users(:tyson))
        create(:accepted_user_friendship, friend: users(:tyson), user: @friend)
